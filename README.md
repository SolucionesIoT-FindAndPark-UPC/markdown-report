...
|TF| 08/07/2025  |  <br>Vargas Revollé, Ariana<br> <br>Obispo Rios, Lucero Abigail<br> <br>Cuevas Rios, Eric Fernando<br> <br>Elsner De La Torre Ugarte, Julio Esteban<br> <br>Herrera González, Luis Eduardo<br>   | Desarrollo de la solución y despliegue para el Sprint 3. Actividades de cierre, documentación final y presentación de resultados.             |
...
- [4.2.2. Bounded Context: Parking Site](#422-bounded-context-parking-site)
...
- [4.2.3. Bounded Context: Camera Feed](#423-bounded-context-camera-feed)
...
- [4.2.4. Bounded Context: Parking Circulation](#424-bounded-context-parking-circulation)
...
- [4.2.7. Bounded Context: Ticket Validation](#427-bounded-context-ticket-validation)
...
- [4.2.8. Bounded Context: Notifications](#428-bounded-context-notifications)
...
- [4.2.9. Bounded Context: Profiles](#429-bounded-context-profiles)
...
| ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta                                 | **Obispo Rios, Lucero Abigail**:<br><br>TB1<br>Participar en reuniones de equipo para definir el alcance del proyecto y la arquitectura.<br><br>TP<br>El desarrollo de las guías de estilo y la arquitectura de información permitió establecer una base sólida para la Landing Page y Página Web, asegurando coherencia visual y una navegación intuitiva. Se logró aplicar buenas prácticas de SEO y diseño responsive, cumpliendo con los estándares definidos.<br><br>TB2<br>Desarrollé la aplicación móvil, desde el diseño de pantallas hasta la integración con los servicios backend, implementando funcionalidades principales y validando su funcionamiento en conjunto con el equipo.<br><br>TF<br>Lideré las pruebas de usabilidad y la validación final de la aplicación móvil, incorporando el feedback para optimizar la experiencia. Colaboré en la preparación de la demostración en vivo del producto, asegurando que el flujo de la app fuera coherente con el sistema.<br><br>**Cuevas Rios, Eric Fernando**:<br><br>TB1<br>Participar en la repartición de tareas así como en el diseño y formulación del proyecto.<br><br>TP<br>Se apoyó en el desarrollo del wireframe y mock-up de la Landing Page, y validándolo con feedback del equipo.<br><br>TB2<br>Mejoré la web app, implementando nuevas funcionalidades y optimizando la experiencia de usuario, asegurando la integración de los módulos desarrollados durante este sprint.<br><br>TF<br>Coordiné la fase final de pruebas integrales y corrección de errores (bug fixing) en la web app, garantizando su estabilidad y rendimiento óptimo. Participé activamente en el despliegue final de la solución y en la elaboración del informe técnico del proyecto.<br><br>**Vargas Revollé, Ariana**:<br><br>TB1<br>Desarrollo del análisis competitivo y colaboré en decisiones estratégicas, facilitando acuerdos y direccionando al equipo hacia objetivos comunes durante el diseño de la solución.<br><br>TP<br>Desarrollé los wireframes y mockups de la Página Web, considerando los requerimientos de usabilidad y experiencia de usuario.<br><br>TB2<br>Desarrollé el backend, definiendo la arquitectura de los servicios, modelos y endpoints necesarios para la integración de la web app, mobile app y edge node. Resolví retos técnicos para garantizar la escalabilidad y seguridad del sistema.<br><br>TF<br>Supervisé la integración final de todos los componentes con el backend, realizando pruebas de carga para asegurar la robustez del sistema. Asumí un rol de liderazgo en la validación técnica de la solución completa, confirmando que cumpliera con todos los requerimientos funcionales y no funcionales definidos.<br><br>**Elsner De La Torre Ugarte, Julio Esteban**:<br><br>TB1<br>Brindar ideas en reuniones cada semana del equipo con la finalidad de realizar retroalimentación y mejora de aspectos del informe.<br><br>TP<br>Se diseñaron los wireflows y userflows, garantizando una experiencia intuitiva. Se compartieron los flujos con el equipo para recibir feedback.<br><br>TB2<br>Desarrollé el edge node encargado de la comunicación entre los dispositivos IoT y el backend, asegurando su correcto funcionamiento e integración dentro del sistema.<br><br>TF<br>Realicé las pruebas finales de integración continua entre el edge node y los dispositivos IoT, optimizando la comunicación y la latencia. Contribuí significativamente en la redacción del informe final, detallando la arquitectura y funcionamiento de mi módulo, y apoyando en la cohesión del documento.<br><br>**Herrera González, Luis Eduardo**:<br><br>TB1<br>Coordiné reuniones y tareas para agilizar el avance del proyecto, promoví la participación y acuerdos del equipo para mejorar el informe y cumplir los objetivos.<br><br>TP<br>Se configuró el entorno de desarrollo y se gestionó el control de versiones con Git, evitando conflictos en el código. Los despliegues se realizaron sin errores gracias a la documentación.<br><br>TB2<br>Desarrollé el código de los dispositivos IoT, implementando la comunicación con el edge node y el backend, y asegurando el monitoreo y registro de datos en tiempo real.<br><br>TF<br>Coordiné la preparación de la presentación y demostración final del proyecto, unificando los aportes del equipo y asegurando el cumplimiento de los plazos. Realicé la validación final del hardware IoT en un entorno simulado real, confirmando la correcta recolección y envío de datos para la demo.<br><br> | TB1: Todos los integrantes participaron activamente en reuniones de equipo, aportando ideas, colaborando en la toma de decisiones estratégicas y facilitando acuerdos. Esto fortaleció el liderazgo conjunto y permitió dirigir al grupo hacia objetivos claros y comunes, asegurando así una coordinación efectiva en el diseño y desarrollo del proyecto.<br><br>TP: En el Sprint #1 se logró implementar con éxito la landing page y página web funcional. El equipo trabajó coordinadamente para integrar las funcionalidades core alineadas a los requisitos funcionales de valor para los usuarios finales. La colaboración permitió resolver desafíos técnicos y alinear los diferentes aspectos del proyecto, desde el diseño hasta la implementación final.<br><br>TB2: Durante este sprint se logró la integración completa de los diferentes módulos del sistema, incluyendo mejoras en la web app, el desarrollo de la aplicación móvil, la creación del backend, el edge node y la programación de los dispositivos IoT. El trabajo conjunto y la comunicación constante permitieron entregar una solución robusta y funcional, alineada a los objetivos propuestos y lista para pruebas en un entorno real.<br><br>TF: En la etapa final, el equipo demostró un liderazgo conjunto consolidado al coordinar la integración de todos los módulos, ejecutar un plan de pruebas exhaustivo y preparar una presentación final unificada. Cada miembro asumió la responsabilidad de su área, asegurando la entrega de una solución completa y funcional que cumplió con todos los objetivos del proyecto.  |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos. | **Obispo Rios, Lucero Abigail**:<br><br>TB1<br>Participar en el proceso de asignación de tareas y cumplir con las actividades asignadas en relación a las entrevistas, To-Be y As-Is Scenario Mapping, Journey Mapping, Historias de Usuario, EventStorming, entre otros.<br><br>TP<br>Participé activamente en las sesiones de arquitectura de información, aportando ideas para los sistemas de navegación y etiquetado SEO que mejoraron la usabilidad del proyecto.<br><br>TB2<br>Planifiqué y organicé el desarrollo de la aplicación móvil, asignando tareas prioritarias y asegurando la colaboración del equipo para cumplir los objetivos establecidos en el sprint.<br><br>TF<br>Participé en la planificación de las pruebas finales y en la creación de la documentación para el usuario, asegurando un ambiente de colaboración para recibir e integrar feedback de mis compañeros sobre la aplicación móvil.<br><br>**Cuevas Rios, Eric Fernando**:<br><br>TB1<br>Realicé los puntos asignados, siendo estos los bounded context de Monitoring y ticket validation, así como el software configuration management.<br><br>TP<br>Documenté el proceso de despliegue, configuración e implementación, para replicar estos procesos fácilmente y sin errores para el próximo sprint.<br><br>TB2<br>Organicé y documenté las mejoras de la web app, gestionando las prioridades y asegurando el cumplimiento de los entregables definidos.<br><br>TF<br>Establecí un plan de pruebas para la web app y lo ejecuté en colaboración con los responsables de otros módulos, cumpliendo con la meta de entregar una aplicación estable para la fecha límite. Fomenté la inclusión de ideas para la mejora final del producto.<br><br>**Vargas Revollé, Ariana**:<br><br>TB1<br>Contribuí a la planificación de tareas clave como el Impact Mapping, entrevistas y definición de contextos, asegurando un ambiente de trabajo inclusivo y la entrega puntual de resultados.<br><br>TP<br>Trabajé en conjunto con el equipo de desarrollo para diseñar los mockups e implementar funcionalidades core en la aplicación web.<br><br>TB2<br>Organicé las tareas relacionadas al backend, planificando sprints cortos para garantizar entregas continuas y fomentando la colaboración entre los distintos módulos.<br><br>TF<br>Planifiqué y supervisé las tareas de pruebas de integración del backend, estableciendo metas claras para la validación de cada endpoint. Promoví un entorno de comunicación abierta para resolver rápidamente los bloqueos técnicos entre los diferentes componentes.<br><br>**Elsner De La Torre Ugarte, Julio Esteban**:<br><br>TB1<br>Elaboré con mis compañeros el proceso de event storming, AS-IS, C4, entre otros procesos clave para la culminación de la TB1.<br><br>TP<br>Diseñé los wireflows y diagramas de flujo de usuario que guiaron la implementación de las interfaces de la aplicación.<br><br>TB2<br>Planifiqué y coordiné el desarrollo del edge node, gestionando las tareas y asegurando la integración efectiva con los dispositivos IoT y el backend.<br><br>TF<br>Colaboré activamente en la definición de los casos de prueba finales para el sistema completo, asegurando que mi módulo cumpliera con los objetivos de rendimiento. Cumplí con las tareas de documentación técnica asignadas para el informe final.<br><br>**Herrera González, Luis Eduardo**:<br><br>TB1<br>Organicé y planifiqué tareas clave, establecí metas claras y aseguré un entorno de trabajo inclusivo para cumplir con los objetivos del proyecto.<br><br>TP<br>Colaboré en la implementación y despliegue de la página web, asegurando que el diseño final coincidiera con los prototipos aprobados.<br><br>TB2<br>Gestioné el desarrollo del software para los dispositivos IoT, asegurando la planificación y cumplimiento de entregables, y promoviendo la colaboración técnica con los demás módulos del sistema.<br><br>TF<br>Organicé la agenda de trabajo para la entrega final, estableciendo metas diarias para la preparación del informe y la presentación. Aseguré un ambiente inclusivo donde todos los miembros participaron en la revisión final del proyecto para cumplir el objetivo de una entrega exitosa.<br><br> | TB1: Cada miembro del equipo contribuyó en la planificación, asignación y cumplimiento de tareas específicas, promoviendo un ambiente inclusivo y de trabajo colaborativo. La participación activa en actividades como entrevistas, EventStorming, mapeos de escenarios y definición de contextos permitió alcanzar los objetivos propuestos de manera puntual y organizada, fortaleciendo la eficiencia y cohesión del equipo.<br><br>TP: El despliegue exitoso de la landing page y página web se logró mediante una planificación colaborativa donde cada integrante aportó con sus habilidades. Se establecieron metas claras para el diseño, desarrollo e implementación, cumpliendo con los objetivos planteados para este sprint inicial.<br><br>TB2: La colaboración continua y la planificación estructurada permitieron cumplir los objetivos del sprint, integrando de manera efectiva los nuevos módulos al sistema. El ambiente inclusivo, la comunicación y la responsabilidad en el seguimiento de tareas fueron claves para lograr una solución integral y lista para pruebas funcionales.<br><br>TF: El equipo fomentó un entorno altamente colaborativo durante la fase final, planificando y ejecutando las tareas de validación, documentación y despliegue. Se establecieron metas claras para la entrega final, y mediante la comunicación constante y el apoyo mutuo, se superaron los desafíos de la integración, cumpliendo con éxito el objetivo de presentar un producto final robusto y bien documentado. |
...
| TS03           | Sensores de peso IoT en cada Estacionamiento                                            | Como desarrollador, quiero instalar e integrar sensores de peso IoT en cada plaza de estacionamiento, para detectar la ocupación en tiempo real y alimentar el sistema de disponibilidad.                                                                                    | Feature: Detección de ocupación en tiempo real<br><br>Scenario: Un vehículo ocupa una plaza vacía<br>Given que el sensor de peso está activo en una plaza de estacionamiento<br>When un vehículo se estaciona<br>Then el sistema marca esa plaza como ocupada en el sistema<br><br>Scenario: El sensor reporta falsos positivos<br>Given que el sensor está mal calibrado<br>When no hay vehículo presente<br>Then el sistema marca incorrectamente la plaza como ocupada<br>And se notifica al administrador de la anomalía                                                                                                                                                                                                                                                                                                                                                                                                     | EP02 |
...
| Sprint 1 Review Summary | En el sprint 2 concluimos el desarrollo de landing page y el primer avance de el front end de la web aplicacion |
...
| Sprint # | Sprint 3 |
| :---- | :---- |
| Sprint Planning Background | En este sprint se plantea finalizar el desarrollo completo de la solución, integrando los distintos módulos y funcionalidades definidas en los sprints anteriores. Se revisan las tareas pendientes y se distribuyen entre los integrantes del equipo para alcanzar el objetivo general del proyecto. |
| Date | 2025-07-20 |
| Time | 9:00 PM |
| Location | Google Teams / Whatsapp |
| Prepared By | Obispo Rios, Lucero Abigail |
| Attendees (to planning meeting) | Herrera González, Luis Eduardo Obispo Rios, Lucero Abigail Cuevas Rios, Eric Fernando Elsner De La Torre Ugarte, Julio Esteban Vargas Revollé, Ariana |
| Sprint 2 Review Summary | En el sprint 2 se logró presentar un 70% de las aplicaciones que se utilizarían en la solución. Se completó la implementación de componentes esenciales como el reconocimiento de placas, interfaz web, y sincronización con la base de datos. |
| Sprint 1 Retrospective Summary | Se identificaron mejoras en el diseño de la aplicación web, así como funcionalidades faltantes. Se propuso un enfoque más colaborativo para distribución de tareas y revisión de código. |
| Sprint Goal & User Stories | |
| Sprint 3 Goal | Nuestro objetivo es concluir el desarrollo completo e integrado del sistema ParkUp, incluyendo backend, reconocimiento de placas y sincronización con la base de datos.<br>Creemos que esto permitirá una experiencia fluida y operativa tanto para usuarios como para administradores del sistema.<br>Esto se va a ver confirmado cuando todas las funcionalidades estén desplegadas, funcionando correctamente e integradas entre sí. |
...
| User Story | User Story Title | Work Item ID | Work Item Title | Description | Estimation (Hours) | Assigned To | Status |
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| US31-3 | Retiro posterior al pago manual del estacionamiento | TSK-35 | Desarrollar interfaz de pago de conductor | Programar la lógica que verifique si el usuario ha completado el pago manual antes de habilitar la opción de retiro. | 1 | Obispo Rios, Lucero Abigail | Done |
|  |  | TSK-36 | Implementar validacion de pago para la salida de parking en backend | Crear la pantalla o mensaje de confirmación que se muestra al usuario tras el pago manual, indicando que ya puede salir del estacionamiento. | 2 | Obispo Rios, Lucero Abigail | Done |
|  |  | TSK-37 | Pruebas de flujo e salida | Testear diferentes escenarios donde el usuario realiza el pago manual y luego intenta salir, incluyendo posibles errores y casos de uso extremos. | 2 | Obispo Rios, Lucero Abigail | Done |
| US49-2 |  Cambio de luz LED cuando un carro se estaciona | TSK-38 | Integración del sensor de ocupación con el LED | Programar la comunicación entre el sensor de peso y el LED para que este cambie de color o estado automáticamente. | 2 | Herrera González, Luis Eduardo |  |
|  |  | TSK-39 | Implementar control físico del LED en el hardware | Desarrollar el código embebido que activa o apaga el LED según la señal recibida por el microcontrolador. | 3 | Herrera González, Luis Eduardo |  |
| TS01-3 |  Puerta de Entrada del Parking IoT con Cámara | TSK-40 | Instalación y configuración de la cámara IoT | Configurar la cámara para captar imágenes o video de la entrada del estacionamiento y conectarla a la red IoT. | 4 | Herrera González, Luis Eduardo | Done |
|  |  | TSK-41 | Integración de la cámara con el sistema de acceso | Programar la lógica que recibe la imagen/video y la asocia con el evento de ingreso del vehículo. | 3 | Herrera González, Luis Eduardo | Done |
|  |  | TSK-42 | Desarrollo de lógica de apertura automática | Implementar el control de la puerta/barra de entrada, asegurando que se abra al detectar y validar el acceso. | 2 | Herrera González, Luis Eduardo | Done |
| TS02-3 |  Puerta de Salida del Parking IoT con Cámara | TSK-43 | Configuración de la cámara en la salida | Instalar y configurar la cámara para registrar la salida de los vehículos. | 2 | Elsner De La Torre Ugarte, Julio Esteban | Done |
|  |  | TSK-44 | Integración de la cámara con el sistema de salida |  Asegurar que la cámara pueda registrar cada evento de salida y asociarlo al usuario correspondiente. | 4 | Elsner De La Torre Ugarte, Julio Esteban | Done |
|  |  | TSK-45 | Desarrollo de lógica de apertura automática en la salida | Implementar la lógica para abrir la puerta/barra de salida cuando se valide el retiro del vehículo. | 6 | Herrera González, Luis Eduardo | Done |
| TS03-3 | Sensores de peso IoT en cada Estacionamiento | TSK-46 | Selección e instalación de sensores de peso | Definir el tipo de sensor a usar y su correcta ubicación en cada espacio de estacionamiento. | 2 | Herrera González, Luis Eduardo |  |
|  |  | TSK-47 | Integración del sensor de peso con la red IoT | Programar la comunicación del sensor con el sistema central para reportar ocupación/desocupación. | 4 | Herrera González, Luis Eduardo | Done |
|  |  | TSK-48 | Desarrollo de lógica de ocupación basada en peso | Implementar el algoritmo que interpreta los datos del sensor para indicar el estado del estacionamiento. | 2 | Herrera González, Luis Eduardo |  |
|  |  | TSK-49 | Validación y pruebas en sitio | Probar el correcto funcionamiento del sensor bajo diferentes condiciones y calibrar si es necesario. | 1 | Herrera González, Luis Eduardo |  |
| TS05-3 |  Edge Node IoT en cada Estacionamiento | TSK-50 | Instalación y configuración del edge node | Implementar y conectar un edge node (dispositivo intermedio) en cada estacionamiento para procesamiento local de datos. | 2 | Herrera González, Luis Eduardo | Done |
|  |  | TSK-51 | Integración con sensores y sistema central | Programar el edge node para recopilar datos de sensores locales y enviarlos al sistema principal. | 3 | Herrera González, Luis Eduardo | Done |
| TS06-2 | Autenticación basada en token JW | TSK-52 | Implementación del backend de autenticación | Programar los endpoints de login, registro y validación de usuario usando JWT. | 2 | Vargas Revollé, Ariana | Done |
|  |  | TSK-53 | Integracion en app movil | Asegurar qué el frontend pueda enviar y recibir tokens JWT correctamente. | 2 | Cuevas Rios, Eric Fernando | Done |
|  |  | TSK-54 | Integracion en app web | Asegurar qué la app movilpueda enviar y recibir tokens JWT correctamente. | 2 | Obispo Rios, Lucero Abigail | Done |
| TS08-3 | Cámaras de Vigilancia IoT | TSK-55 | Selección e instalación de cámaras de vigilancia | Definir los puntos óptimos y tipo de cámara a instalar para máxima cobertura. | 2 | Elsner De La Torre Ugarte, Julio Esteban | Done |
|  |  | TSK-56 | Integración de las cámaras a la red IoT | Conectar las cámaras al sistema para transmitir imágenes/video en tiempo real. | 2 | Elsner De La Torre Ugarte, Julio Esteban | Done |
|  |  | TSK-57 | Implementación de sistema de monitoreo centralizado | Desarrollar el panel donde los administradores pueden ver y gestionar las cámaras. | 2 | Cuevas Rios, Eric Fernando | Done |
| TS14-3 | Implementación de un servicio Parking Circulation con REST API | TSK-58 | Diseño de endpoints REST para circulación | Definir y documentar los endpoints que permiten gestionar la circulación interna de los vehículos (ingreso, salida, recorridos). | 1 | Luis | Done |
|  |  | TSK-59 | Implementación del servicio backend | Desarrollar la lógica en el backend que permita consultar y actualizar el estado de circulación de cada vehículo. | 1 | Herrera González, Luis Eduardo | Done |
|  |  | TSK-60 | Integración con otros módulos (puertas, sensores) | Asegurar la interoperabilidad del servicio con el resto de módulos IoT y frontends. | 1 | Herrera González, Luis Eduardo | Done |
